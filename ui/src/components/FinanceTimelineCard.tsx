...
export function FinanceTimelineCard({
  rows,
  emptyMessage = "No billing entries in this period.",
}: FinanceTimelineCardProps) {
  return (
    <Card>
      <CardHeader className="px-4 pt-4 pb-1">
        <CardTitle className="text-base">Recent billing entries</CardTitle>
        <CardDescription>Top-ups, fees, credits, commitments, and other account-level charges (not tied to individual AI requests).</CardDescription>
      </CardHeader>
